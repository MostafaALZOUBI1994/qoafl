            ...
            :ListView.builder(
              ...
              itemBuilder: (context, index) {
                return Padding(
                  ...
                  child: InkWell(
                    onTap: () async {
                      Product  product= kUser==null?await ProductRepo().getProductDetails(state.products[index].id): await ProductRepo().getProductDetails(state.products[index].id,kUser.userId);
                      Navigator.push (
                        context,
